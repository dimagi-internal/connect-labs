...
registers **197 tools** (write tools are rate-limited and fully argument-logged
to `MCPAuditLog`) — 76 of them generated from the supply-chain
...
79: three are `internal=True` (`catalogue_seed`, `tracker_import`,
