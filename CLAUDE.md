...
registers **196 tools** (write tools are rate-limited and fully argument-logged
to `MCPAuditLog`) — 75 of them generated from the supply-chain
...
78: three are `internal=True` (`catalogue_seed`, `tracker_import`,
