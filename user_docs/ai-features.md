...
- *"Add a column showing the average weight from the last 3 visits"*
- *"Change the status labels from Active/Inactive to Enrolled/Graduated"*
- *"Make the table sortable by visit count"*
