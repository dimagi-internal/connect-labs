...
@register(
    ...
    description=(
        ...
        "`byLLO`) and for every further series under `series.<name>` (KMC has one family, so "
        "`series` is empty for it). Each cell is {id, value, n, band}; `n` is the denominator. Plus "
