"""Seeds the procurement half: suppliers, EOI rounds, solicitations, awards.

Idempotent and deterministic — keyed on natural names and driven by a fixed
PRNG seed, so re-running updates in place rather than duplicating. The demo
narrative itself lives in :mod:`.data`; this module only writes it.
"""
import os
