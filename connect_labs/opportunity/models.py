...
from connect_labs.users.models import User, UserCredential  # noqa: E402
from connect_labs.utils.db import BaseModel, slugify_uniquely  # noqa: E402
...
class OpportunityAccess(models.Model):
    ...
    def managed_opportunity(self):
        from connect_labs.program.models import ManagedOpportunity
...
class UserVisitQuerySet(models.QuerySet):
    def with_any_flags(self, flags):
        from connect_labs.utils.flags import Flags
...
class UserVisit(XFormBaseModel):
    ...
    def flags(self):
        if self.flag_reason is not None:
            from connect_labs.utils.flags import FlagLabels
...
class LabsRecord(models.Model):
    ...
    from connect_labs.program.models import Program
