...
from connect_labs.opportunity.visit_import import get_exchange_rate
...
def populate_amount_usd(apps, schema_editor):
    ...
    for payment in payments:
        ...
        payments_to_update = Payment.objects.filter(
            date_paid=date_paid, opportunity_access__opportunity__currency=currency
        )
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.RunPython(populate_amount_usd, migrations.RunPython.noop, hints={"run_on_secondary": False}),
    ]
