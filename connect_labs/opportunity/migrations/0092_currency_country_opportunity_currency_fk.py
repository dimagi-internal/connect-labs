...
from connect_labs.program.utils import populate_currency_and_country_fk_for_model
...
class Migration(migrations.Migration):
    dependencies = [
        ("opportunity", "0091_generate_automated_service_delivery_invoice_periodic_task"),
    ]
