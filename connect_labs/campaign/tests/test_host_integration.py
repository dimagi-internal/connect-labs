...
CAMPAIGN_MW = "connect_labs.campaign.middleware.CampaignOAuthSessionMiddleware"
HOSTILE_MW = "connect_labs.campaign.tests.test_host_integration.HostileUpstreamOAuthMiddleware"
