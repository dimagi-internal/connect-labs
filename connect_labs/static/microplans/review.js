(function () {
  ...
  function render(data, opts) {
    ...
    // Purely informational — WA Revisit's Phase 3 hand-off tags every plan it
    ...
    if (banner) {
      ...
      if (isMopup)
        banner.textContent =
          '↻ WA Revisit plan (run #' + data.run_meta.mopup_run_id + ')';
    }
  ...
  // Grouped into Under-5 / Total for the dropdown.
