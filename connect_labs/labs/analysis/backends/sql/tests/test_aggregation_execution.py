...
class TestAggregationSqlExecution:
    ...
    def test_pre_aggregated_field_executes_as_two_pass(self, db):
        ...
        """
        from connect_labs.labs.analysis.backends.sql.query_builder import _pre_aggregated_field_sql
    ...
    def test_sql_agrees_with_inmemory_mirror_on_mixed_fixture(self, db):
        ...
        """
        from connect_labs.labs.analysis.backends.sql.tests.reference_aggregation import aggregate
