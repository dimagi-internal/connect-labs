...
class ScaleDialValidationAgent(BaseAIReviewAgent):
    ...
    def review(self, context: ReviewContext) -> ReviewResult:
        ...
        try:
            ...
            self.logger.error(f"Scale dial API error: status={e.response.status_code} {error_detail}")
        ...
        # costs a full client timeout of wall-clock per image.
            ...
            self.logger.error(f"Scale dial timeout after {self.DEFAULT_TIMEOUT}s: {e}")
