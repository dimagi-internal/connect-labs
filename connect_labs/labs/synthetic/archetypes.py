...
Mirrors the FLW archetype pattern (see ``connect_labs/labs/synthetic/self_service.py``
and ``connect_labs/labs/synthetic/program_admin_demo.py``) for the other
...
into ``connect_labs/labs/synthetic/generator/fixtures/muac_reasons.json`` so it's
...
# The image server (connect_labs/labs/synthetic/image_server.py) serves
...
class TaskArchetype:
    ...
    ``connect_labs/labs/synthetic/generator/fixtures/ocs_templates.py``.
    """
...
def build_task_data(
    *,
    ...
    # (see connect_labs/templates/tasks/task_create_edit.html and the
    # task-data composition in connect_labs/tasks/views.py).
