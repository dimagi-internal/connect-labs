...
from connect_labs.labs.synthetic.generator.fixtures.fields import _outlier, fill_form_json
...
def test_fill_form_json_emits_repeat_group_as_array():
    ...
    from connect_labs.labs.synthetic.generator.fixtures.manifest import CategoricalDistribution, RepeatGroupSpec
...
def test_fill_form_json_repeat_array_wins_over_scalar_leaf():
    ...
    from connect_labs.labs.synthetic.generator.fixtures.manifest import RepeatGroupSpec
...
def test_categorical_value_respects_frequencies():
    from connect_labs.labs.synthetic.generator.fixtures.fields import _categorical_value
    from connect_labs.labs.synthetic.generator.fixtures.manifest import CategoricalDistribution
...
def test_text_fields_are_fabricated_not_stubbed():
    ...
    from connect_labs.labs.synthetic.generator.fixtures.fields import _COUNTRIES, _fabricate_text
