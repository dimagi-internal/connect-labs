...
def test_muac_is_recognised_wherever_the_manifest_puts_it():
    ...
    assert stats == {"eligible_visits": 2, "images_assigned": 2, "reading_mismatches": 0, "unmatched_visits": 0}
...
def test_zero_assignments_are_reported_not_silent(caplog):
    ...
    assert stats == {"eligible_visits": 0, "images_assigned": 0, "reading_mismatches": 0, "unmatched_visits": 0}
...
def test_eligible_visits_that_all_get_skipped_blame_the_config_not_the_fields(caplog):
    ...
    assert stats == {"eligible_visits": 1, "images_assigned": 0, "reading_mismatches": 0, "unmatched_visits": 0}
