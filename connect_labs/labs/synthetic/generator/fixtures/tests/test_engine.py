...
def test_mirror_applies_seeded_field_outlier_and_duplicate_anomalies():
    ...
    from connect_labs.labs.synthetic.generator.fixtures.manifest import Anomaly
...
def test_geography_gps_lands_where_the_service_delivery_pipeline_reads_it():
    ...
    """
    from connect_labs.microplans.service_delivery.points import _parse_packed_location
