...
from connect_labs.labs.synthetic.generator.fixtures.copula import build_copula_sampler, nearest_psd
...
def test_numeric_margin_clamps_to_bounds():
    ...
    from connect_labs.labs.synthetic.generator.fixtures.copula import NumericMargin
