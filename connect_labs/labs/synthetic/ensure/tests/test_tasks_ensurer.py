...
from connect_labs.labs.synthetic.ensure.ensurers.run_audits import ensure_run_audits
from connect_labs.labs.synthetic.ensure.ensurers.tasks import ensure_tasks
from connect_labs.labs.synthetic.ensure.ensurers.weekly_runs import ensure_weekly_runs
from connect_labs.labs.synthetic.ensure.env_manifest import (
    OppDataResource,
    RunAuditsResource,
    TasksResource,
    WeeklyRunsResource,
...
def test_reconciles_stale_investigating_task_to_closed_on_reuse(tmp_path):
    ...
    from connect_labs.labs.synthetic.walkthrough_kit import generate_task_from_archetype
...
def test_reconciles_stale_audit_to_completed_for_resolved_arc(tmp_path):
    ...
    from connect_labs.labs.synthetic.walkthrough_kit import generate_audit_from_archetype
