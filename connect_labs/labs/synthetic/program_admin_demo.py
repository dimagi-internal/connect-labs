...
``connect_labs/mcp/tools/program_admin_demo.py`` is a 30-line shim
...
# connect_labs/workflow/templates/chc_nutrition_analysis.py byte for
...
def _refresh_render_code(wda, definition, template_key: str) -> bool:
    ...
    ``connect_labs/workflow/templates/<name>.py`` source, but the
...
def program_admin_demo_seed(
    ...
    *,
    ...
    from connect_labs.labs.synthetic.walkthrough_kit import (
        VisitIdSequence,
        apply_action_spec,
    ...
    try:
        ...
        from connect_labs.workflow.templates.program_admin_report import compute_program_admin_rollup
