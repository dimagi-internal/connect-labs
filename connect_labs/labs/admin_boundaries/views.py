...
from connect_labs.labs.admin_boundaries.services import (
...
class BoundaryCoverageAPIView(LoginRequiredMixin, View):
    ...
    def get(self, request):
        ...
        """
        from connect_labs.labs.admin_boundaries.services import get_opp_boundary_coverage
...
class BoundaryMapView(LoginRequiredMixin, TemplateView):
    ...
    def _load_enrichment_data(self) -> list:
        ...
        https://github.com/dimagi-internal/connect-labs/blob/8da9b746/connect_labs/solicitations/data_access.py
