...
from connect_labs.solicitations.views import _fetch_url_content, validate_url_safe
...
class TestSSRFProtection:
    ...
    def test_fetch_url_content_blocks_internal(self, url):
        ...
        with patch("connect_labs.solicitations.views.validate_url_safe", wraps=validate_url_safe):
