...
class TestHeadlessGuard:
    ...
    def test_fetch_cchq_forms_raises_headless_error_when_request_is_none(self):
        ...
        from connect_labs.labs.analysis.backends.sql.cchq_fetcher import fetch_cchq_forms_as_visit_dicts
    ...
    def test_commcare_data_access_check_token_valid_raises_when_headless(self):
        ...
        from connect_labs.labs.integrations.commcare.api_client import CCHQHeadlessError, CommCareDataAccess
