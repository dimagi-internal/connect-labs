...
function ChcSortTh(props) {
  ...
  return ce(
    ...
    {
      className:
        'px-3 py-2 text-left text-xs font-semibold uppercase tracking-wider bg-green-900 text-green-100 cursor-pointer select-none hover:bg-green-800',
      style: props.style || {},
      onClick: function () {
        onSort(col, nextDir);
      },
...
function ChcAuditHistory(props) {
  var reportRows = props.reportRows,
    entryRows = props.entryRows,
    taskRows = props.taskRows,
    oppIds = props.oppIds,
    ...
    function () {
      ...
      copy.sort(function (a, b) {
        var r = a._r,
          ...
          va,
          vb;
        if (sort.col === 'opportunity') {
          va = oppNames[r.opportunity_id] || String(r.opportunity_id);
          vb = oppNames[s.opportunity_id] || String(s.opportunity_id);
        } else if (sort.col === 'date_created') {
          va = r.date_created || '';
          vb = s.date_created || '';
          ...
          ce(
            ...
            ce(
              ...
              ce(
                ChcSortTh,
                Object.assign(
                  { colKey: 'opportunity', label: 'Opportunity' },
                  thProps,
                ),
              ),
              ce(
            ...
            sorted.length === 0
              ...
              : sorted.map(function (row, i) {
                  ...
                  return ce(
                    ...
                    ce(
                      'td',
                      { className: 'px-3 py-2 font-medium text-green-900' },
...
function ChcMetricDetail(props) {
  ...
  var visibleCols = _visState[0],
    setVisibleCols = _visState[1];

  var shownMetrics = React.useMemo(
    function () {
      return CHC_METRICS.filter(function (m) {
        return visibleCols[m.key];
      });
    },
    [visibleCols],
  );
  ...
  var filteredEntries = React.useMemo(
    function () {
      ...
      if (repFilter !== 'all') {
        ...
        rows = rows.filter(function (e) {
          return (
            String(e.report_id) === rId && String(e.opportunity_id) === rOppId
          );
        });
      }
      if (runDateFilter !== 'all') {
        ...
        rows = rows.filter(function (e) {
          return matchKeys[
            String(e.report_id) + ':' + String(e.opportunity_id)
          ];
        });
      }
      return rows;
        ...
        CHC_METRICS.forEach(function (m) {
          ...
          if (values.length > 0) {
            ...
            avgResults[m.key] = {
              ...
              in_range: anyFlagged ? false : true,
            };
          } else {
            avgResults[m.key] = {
              value: null,
      ...
      copy.sort(function (a, b) {
        ...
        if (col === 'opportunity') {
          ...
          var resA = chcParseResults(a.results),
            resB = chcParseResults(b.results);
          var objA = resA[col],
            objB = resB[col];
          var numA =
  ...
  var totalFlags = React.useMemo(
    function () {
      var n = 0;
      sortedFlwRows.forEach(function (row) {
        n += countMetricFlags(row.results);
      });
      return n;
    },
    [sortedFlwRows],
    ...
    ce(
      ...
      ce(
        'select',
        {
          ...
          value: runDateFilter,
          onChange: function (e) {
            setRunDateFilter(e.target.value);
          },
        },
        ce('option', { value: 'all' }, 'All Dates'),
        runDates.map(function (d) {
          return ce('option', { key: d, value: d }, d);
        }),
      ),
      ce(
        'span',
      ...
      ce(
        ...
        ce(
          ...
          {
            className:
              'cursor-pointer text-xs font-semibold uppercase tracking-wider text-green-800 border border-green-300 rounded px-3 py-1.5 bg-green-50 hover:bg-green-100 list-none',
          },
          'Columns ▾',
        ),
        ce(
          ...
          {
            className:
              'absolute right-0 top-full z-30 bg-white border border-gray-200 rounded shadow-lg p-3 min-w-48 mt-1',
            onClick: function (e) {
              e.stopPropagation();
            },
          },
          ...
          CHC_METRICS.map(function (m) {
            return ce(
              'label',
              {
                key: m.key,
                className:
                  'flex items-center gap-2 py-1 cursor-pointer text-sm hover:text-green-800',
              },
              ce('input', {
                type: 'checkbox',
          ...
          ce(
            'div',
            { className: 'border-t border-gray-100 mt-2 pt-2 flex gap-2' },
            ce(
              'button',
              {
          ...
          ce(
            ...
            ce(
              ...
              ce(
                ChcSortTh,
                Object.assign(
                  { colKey: 'worker', label: 'Connect Worker' },
                  thProps,
                ),
              ),
            ...
            sortedFlwRows.length === 0
              ...
              : sortedFlwRows.map(function (row, i) {
                  ...
                  var cells = shownMetrics.map(function (m) {
                    var obj = res[m.key];
                    var isNA =
                      !obj || !obj.has_sufficient_data || obj.value == null;
                    ...
                    ce(
                      ...
                      row._auditCount > 1
                        ? ce(
                            ...
                            {
                              className:
                                'ml-1 text-gray-400 text-xs font-normal',
                              title: row._auditCount + ' audits averaged',
                            },
                            '×' + row._auditCount,
                          )
                        : null,
...
function ChcFLWLongitudinal(props) {
  ...
  var expandedWorkers = _expandState[0],
    setExpandedWorkers = _expandState[1];
  ...
  var scopedReports = React.useMemo(
    function () {
      var base = reportRows.filter(function (r) {
        return r.status === 'completed';
      });
      return oppFilter === 'all'
        ? base
  ...
  function getFlwTasksWithCycle(username) {
    var flwTasks = taskRows.filter(function (t) {
            ...
            ce(
              ...
              ce(
                ...
                ce(
                  ...
                  ce(
                    ...
                    {
                      className:
                        'bg-green-900 text-white px-3 py-2 text-left text-xs font-semibold uppercase tracking-wider whitespace-nowrap min-w-40',
                  ...
                  ce(
                    ...
                    {
                      className:
                        'bg-green-900 text-white px-3 py-2 text-center text-xs font-semibold uppercase tracking-wider whitespace-nowrap',
                    },
                    'Total Flags',
                  ),
                  ce(
                  ...
                  cycles.map(function (c, i) {
                    ...
                    return ce(
                      'th',
                      {
                        key: i,
                        className:
                          'bg-green-800 text-green-100 px-3 py-2 text-center font-semibold min-w-40',
                      },
                      chcDateRange(r.period_start, r.period_end),
                    );
                  }),
              ...
              ce(
                ...
                flwCycleData.map(function (row, i) {
                  ...
                  var flwTasks = isExpanded
                    ? getFlwTasksWithCycle(row.username)
                    : [];
                  ...
                  return [
                    ...
                    ce(
                      ...
                      ce(
                        ...
                        {
                          className:
                            'border-r border-gray-200 px-3 py-2 font-medium whitespace-nowrap bg-gray-50',
                          style: { position: 'sticky', left: 0 },
                        },
                        ce(
                          'span',
                      ...
                      ce(
                        ...
                        {
                          className:
                            'border-r border-gray-200 px-3 py-2 text-center font-bold text-gray-700',
                        },
                        row.totalTasks,
                      ),
                      row.cycles.map(function (cs, j) {
                        ...
                        var mPct =
                          cs.totalMetricsWithData > 0
                            ? Math.round(
                                (mPassed / cs.totalMetricsWithData) * 100,
                              )
                            : 100;
                        var tPct =
                          cs.nTasks > 0
                            ? Math.round((cs.closedTasks / cs.nTasks) * 100)
                            : null;
                        var flagCls =
                          cs.metricFlags === 0
                            ? ''
                        ...
                        return ce(
                          'td',
                          {
                            key: j,
                            className:
                              'border-r border-gray-200 px-3 py-2 ' + flagCls,
                          },
                          ce(
                            'div',
                    ...
                    isExpanded
                      ? ce(
                          'tr',
                          { key: 'e' + i, className: 'bg-gray-50' },
                          ce(
                            'td',
                            { colSpan: colCount, className: 'px-4 py-3' },
                            ce(
                              'div',
                              {
                                className:
                                  'text-xs font-semibold uppercase text-gray-500 mb-2',
                              },
                              'Tasks for ' +
                                displayName +
                                ' (' +
                                  ...
                                  ce(
                                    ...
                                    ce(
                                      ...
                                      ce(
                                        ...
                                        {
                                          className:
                                            'px-3 py-1.5 text-left font-semibold text-gray-600 border-b border-gray-200',
                                        },
                                        'Audit Cycle',
                                      ),
                                      ce(
                                    ...
                                    flwTasks.map(function (tw, k) {
                                      ...
                                      return ce(
                                        ...
                                        ce(
                                          ...
                                          {
                                            className:
                                              'px-3 py-1.5 text-gray-600 whitespace-nowrap',
                                          },
                                          r
                                            ? chcDateRange(
                                                r.period_start,
                                        ...
                                        ce(
                                          ...
                                          {
                                            className:
                                              'px-3 py-1.5 text-gray-500 whitespace-nowrap',
                                          },
    ...
    function () {
      ...
      var groups = sortedOppIds.map(function (oid) {
        ...
        var auditRows = reports.map(function (r) {
          ...
          var totalFlags = CHC_METRICS.reduce(function (s, m) {
            return s + metricFlags[m.key];
          }, 0);
          return {
            report: r,
            metricFlags: metricFlags,
        ...
        var subMetricFlags = {};
        CHC_METRICS.forEach(function (m) {
          subMetricFlags[m.key] = auditRows.reduce(function (s, row) {
            return s + row.metricFlags[m.key];
          }, 0);
        });
        var subTotalFlags = CHC_METRICS.reduce(function (s, m) {
          return s + subMetricFlags[m.key];
        }, 0);

        return {
          oppId: oid,
          oppName: oppNames[oid] || 'Opp #' + oid,
          auditRows: auditRows,
          subMetricFlags: subMetricFlags,
      ...
      CHC_METRICS.forEach(function (m) {
        grandMetricFlags[m.key] = groups.reduce(function (s, g) {
          return s + g.subMetricFlags[m.key];
        }, 0);
      });
      var grandTotalFlags = CHC_METRICS.reduce(function (s, m) {
        return s + grandMetricFlags[m.key];
      }, 0);

      return {
        groups: groups,
        grandMetricFlags: grandMetricFlags,
        grandTotalFlags: grandTotalFlags,
      };
    },
  ...
  return ce(
    ...
    ce(
      ...
      ce(
        'span',
        { className: 'text-xs text-gray-400' },
        tableData.groups.reduce(function (s, g) {
          return s + g.auditRows.length;
        }, 0) + ' audits',
      ),
      // Column picker
      ce(
            ...
            ce(
              ...
              ce(
                ...
                ce(
                  ...
                  ce(
                    ...
                    {
                      className:
                        'bg-green-900 text-green-100 px-3 py-2 text-left text-xs font-semibold uppercase tracking-wider whitespace-nowrap',
                    },
                    'Opportunity',
                  ),
                  ce(
                  ...
                  shownMetrics.map(function (m) {
                    return ce(
                      'th',
                      {
                        ...
                        title: m.full,
                        className:
                          'bg-green-900 text-green-100 px-3 py-2 text-center text-xs font-semibold uppercase tracking-wider',
                        style: { maxWidth: '72px' },
                      },
                      m.label,
                    );
                  ...
                  ce(
                    ...
                    {
                      className:
                        'bg-green-900 text-green-100 px-3 py-2 text-center text-xs font-semibold uppercase tracking-wider whitespace-nowrap',
                    },
                    'Flags',
                  ),
                ),
              ...
              ce(
                ...
                tableData.groups.map(function (group) {
                  var auditCells = group.auditRows.map(function (row, i) {
                    ...
                    return ce(
                      ...
                      ce(
                        ...
                        {
                          className:
                            'border border-gray-200 px-3 py-1.5 text-left font-medium text-green-900 bg-white whitespace-nowrap',
                        },
                        group.oppName,
                      ),
                      ce(
                        ...
                        {
                          className:
                            'border border-gray-200 px-3 py-1.5 text-left whitespace-nowrap',
                        },
                        (r.date_created || '—').slice(0, 10),
                      ),
                      shownMetrics.map(function (m) {
                      ...
                      ce(
                        ...
                        {
                          className:
                            'border border-gray-200 px-2 py-1.5 text-center font-bold ' +
                            (row.totalFlags > 0
                              ? 'bg-red-100 text-red-800'
                              : 'text-gray-400'),
                        },
                  ...
                  var subRow = ce(
                    'tr',
                    { key: 'sub', className: 'border-b-2 border-green-200' },
                    ce(
                      'td',
                      {
                        className:
                          'border border-green-200 px-3 py-1.5 text-left font-bold text-green-800 bg-green-50 whitespace-nowrap',
                      },
                      group.oppName,
                    ),
                    ce(
                      ...
                      {
                        className:
                          'border border-green-200 px-3 py-1.5 text-left font-bold text-green-800 bg-green-50 whitespace-nowrap text-xs uppercase',
                      },
                      'Subtotal',
                    ),
                    shownMetrics.map(function (m) {
                      ...
                      return ce(
                        'td',
                        {
                          key: m.key,
                          className:
                            'border border-green-200 px-2 py-1.5 text-center font-bold bg-green-50 ' +
                            (n > 0 ? 'text-red-700' : 'text-gray-400'),
                        },
                        n > 0 ? n : '—',
                      );
                    }),
                    ce(
                      ...
                      {
                        className:
                          'border border-green-200 px-2 py-1.5 text-center font-bold bg-green-900 text-white',
                      },
              ...
              ce(
                ...
                ce(
                  ...
                  ce(
                    ...
                    tableData.grandTotalFlags > 0
                      ? tableData.grandTotalFlags
                      : '—',
                  ),
                ),
              ),
