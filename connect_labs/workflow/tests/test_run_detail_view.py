...
@patch("connect_labs.workflow.views.TaskDataAccess")
@patch("connect_labs.workflow.views.AuditDataAccess")
@patch("connect_labs.workflow.views.FlagsDataAccess")
@patch("connect_labs.workflow.views.WorkflowDataAccess")
...
def test_workflow_run_view_injects_audits_and_tasks(mock_org, MockWDA, MockFDA, MockADA, MockTDA, rf):
    ...
    """
    from connect_labs.audit.data_access import AuditSessionRecord
    from connect_labs.tasks.data_access import TaskRecord
    from connect_labs.workflow.data_access import WorkflowDefinitionRecord, WorkflowRunRecord
    from connect_labs.workflow.views import WorkflowRunView
