...
from connect_labs.workflow.templates.audit_par import summarize_run_sessions
...
def test_rollup_buckets_runs_per_opp_and_week():
    from connect_labs.workflow.templates import audit_par as m
...
def test_audit_par_rollup_persists_into_run_state():
    from connect_labs.workflow.job_handlers import audit_par as h
