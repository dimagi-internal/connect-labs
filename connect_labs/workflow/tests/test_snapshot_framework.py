...
class TestResolveSnapshotContract:
    ...
    def test_instance_manifest_wins_over_template_manifest(self):
        from connect_labs.workflow.templates import build_snapshot_for_contract, resolve_snapshot_contract
...
class TestSnapshotSizeCap:
    ...
    def test_under_soft_cap_passes_silently(self):
        from connect_labs.workflow.templates import _check_snapshot_size
    ...
    def test_build_snapshot_for_contract_propagates_size_error(self):
        ...
        from connect_labs.workflow.templates import SnapshotTooLargeError, build_snapshot_for_contract
