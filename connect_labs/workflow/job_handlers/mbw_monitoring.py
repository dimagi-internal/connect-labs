...
def handle_mbw_monitoring_job(job_config: dict, _access_token: str, progress_callback) -> dict:
    ...
    from connect_labs.workflow.templates.mbw_monitoring.serializers import serialize_flw_summary
    ...
    if not flw_statuses and active_usernames:
        try:
            ...
            from connect_labs.workflow.templates.mbw_monitoring.flw_status import get_latest_flw_statuses
