...
import connect_labs.microplans.core.data_access as da_mod
import connect_labs.solicitations.views as sviews
from connect_labs.solicitations.views import SolicitationCreateView
