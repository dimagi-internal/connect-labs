...
from connect_labs.ai.agents.pipeline_agent import (
    build_pipeline_prompt,
    create_pipeline_agent,
    create_pipeline_agent_openai,
)
from connect_labs.ai.agents.solicitation_agent import get_solicitation_agent
from connect_labs.ai.agents.workflow_agent import (
...
try:
    from connect_labs.ai.agents.coding_agent import get_coding_agent
...
from connect_labs.ai.session_store import add_message_to_history, get_message_history
...
Please generate React code to fulfill the user's request. The code should be complete and runnable."""
        ...
        if agent == "vibes" and HAS_CODING_AGENT:
            from connect_labs.ai.agents.coding_agent import CodeResponse
    ...
    try:
        ...
        if agent == "workflow" and definition_id and access_token:
            ...
            try:
                from connect_labs.labs.custom_pipelines.data_access import PipelineDataAccess
