...
class TestFundReportAgent:
    ...
    def test_agent_creation(self):
        ...
        from connect_labs.ai.agents.fund_report_agent import create_fund_report_agent_with_model
...
class TestSolicitationReviewAgent:
    ...
    def test_agent_creation(self):
        from connect_labs.ai.agents.solicitation_review_agent import create_solicitation_review_agent_with_model
