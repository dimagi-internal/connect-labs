...
def scoped(client, django_user_model, monkeypatch):
    from connect_labs.supply_chain import form_views, fulfilment_views, reference_views, views  # noqa: F401
    ...
    for module in ("form_views", "views", "fulfilment_views", "procurement.views", "reference_views"):
