...
def test_the_initial_request_uses_the_same_destination_phrase_throughout(rutf, tender_2000_cartons):
...
def test_a_followup_does_not_ask_for_a_pack_spec_the_item_already_states(rutf, tender_2000_cartons, item_144):
...
def test_a_followup_never_asks_a_supplier_to_enter_our_treatment_protocol(rutf_without_course, tender_2000_cartons):
