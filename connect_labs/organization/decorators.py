...
from connect_labs.opportunity.models import Opportunity
from connect_labs.utils.db import get_object_by_uuid_or_int
from connect_labs.utils.permission_const import ALL_ORG_ACCESS
