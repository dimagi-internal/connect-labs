...
def test_display_name_map_covers_every_demo_user():
    ...
    from commcare_connect.labs.synthetic.program_admin_demo import DISPLAY_NAMES
...
def test_display_name_for_falls_back_to_real_name_for_unknown_id():
    ...
    from commcare_connect.labs.synthetic.program_admin_demo import display_name_for
...
def test_pipeline_row_carries_real_display_name():
    ...
    from commcare_connect.labs.synthetic.program_admin_demo import _build_chc_pipeline_rows
