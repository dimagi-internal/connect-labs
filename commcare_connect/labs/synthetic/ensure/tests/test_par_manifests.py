...
from commcare_connect.labs.synthetic.ensure.env_manifest import EnvManifest
...
def test_manifest_validator_rejects_dangling_reference():
    ...
    from commcare_connect.labs.synthetic.generator.fixtures.manifest import ManifestValidationError
