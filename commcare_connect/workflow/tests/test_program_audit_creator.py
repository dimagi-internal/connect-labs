...
def test_fan_out_generates_per_source_and_records_state(monkeypatch):
    ...
    from commcare_connect.workflow.templates import program_audit_creator as m
...
def test_audit_par_no_longer_supports_default_run():
    from commcare_connect.workflow.templates import get_template, run_default_for_definition
