        ...
        <div className="bg-white rounded-lg shadow-sm p-6 space-y-6">
            ...
            <div className="pt-4 border-t border-gray-200">
                <button
                    ...
                    disabled={selectedOpps.length === 0 || selectedImageTypeIds.length === 0 || instance.status === 'completed'}
                    title={instance.status === 'completed' ? 'Run is completed; cannot create new reviews.' : ''}
