                    ...
                    React.createElement(
                      ...
                      taskTranscript && taskTranscript.length > 0
                        ...
                        ? React.createElement(
                            ...
                            transcriptOcsRequired || (oauthStatus && !oauthStatus.ocs?.active)
                              ? React.createElement(
                                  'div',
                                  ...
                                  React.createElement(
                                    ...
                                    React.createElement('i', { className: 'fa-solid fa-link-slash mr-1' }),
                                    ' OCS authorization required to load AI conversation',
                                  ),
                                  oauthStatus && oauthStatus.ocs && oauthStatus.ocs.authorize_url
                                    ? React.createElement(
                                        'a',
                                        {
                                        ...
                                        React.createElement('i', { className: 'fa-solid fa-arrow-right-to-bracket mr-1' }),
                                        ' Connect to OCS',
                                      )
                                    : null,
                                )
                              : React.createElement(
                                  ...
                                  null,
                                  React.createElement('i', {
                                    className: 'fa-solid ' + (taskTranscriptError ? 'fa-circle-exclamation text-red-500' : 'fa-comment-slash') + ' mr-1',
                                  }),
