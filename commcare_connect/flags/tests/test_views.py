...
@patch("commcare_connect.flags.views.FlagsDataAccess")
def test_post_flag_creates_via_data_access(MockDA, rf):
    ...
    with patch("commcare_connect.flags.views._refuse_if_run_completed") as guard:
        ...
        from commcare_connect.flags import views as v
...
def test_post_flag_returns_400_on_missing_fields(MockDA, rf):
    ...
    with patch("commcare_connect.flags.views._refuse_if_run_completed", return_value=None):
        url = "/labs/workflow/api/503/flags/"
