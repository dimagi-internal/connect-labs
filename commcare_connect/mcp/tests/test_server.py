...
from commcare_connect.mcp.server import CommCarePATVerifier, mcp
from commcare_connect.mcp.tool_registry import list_tools as registry_list_tools
...
def test_run_registry_tool_surfaces_labs_api_detail(monkeypatch):
    ...
    from commcare_connect.mcp.tool_registry import Tool as RegistryToolSpec
