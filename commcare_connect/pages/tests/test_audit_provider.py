...
from commcare_connect.pages.providers.audit import AuditCardProvider
...
@patch("commcare_connect.pages.providers.audit.get_org_data")
...
@patch("commcare_connect.pages.providers.audit.AuditDataAccess")
